...
export function calculateOdds(
  yesStakes: number,
  noStakes: number
): { yesOdds: number; noOdds: number; yesImpliedProbability: number; noImpliedProbability: number } {
...
export function calculatePotentialPayout(
  ...
  yesStakes: number,
  noStakes: number
): { potentialPayout: number; odds: number } {
 ...
 */
export function calculateClaimablePayout(
  userStake: number,
  winningPool: number,
  totalPot: number
): number {

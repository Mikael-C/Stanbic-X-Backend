...
exports.lockoutCheck = lockoutCheck;
exports.getLockedUsersData = getLockedUsersData;
exports.unlockUserById = unlockUserById;
exports.jailbreakMiddleware = jailbreakMiddleware;
 ...
 */
function rateLimitCheck(userId, countRequest = true) {
    const now = Date.now();
 ...
 */
function incrementLockoutCounter(userId) {
    const LOCKOUT_THRESHOLD = 5;
 ...
 */
async function jailbreakMiddleware(req, res, next) {
    try {
        ...
        if (typeof message === 'string' && message.length > 0) {
            ...
            if (detectedPattern) {
                ...
                // Log to database
                try {
                    await prisma_1.prisma.jailbreakAttempt.create({
                        data: {
...
//# sourceMappingURL=jailbreakDefender.js.map